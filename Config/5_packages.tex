...
\usepackage{breqn}
\usepackage{caption}
\usepackage{needspace}   % reserve space before large blocks
\usepackage{pdflscape}   % optional: landscape pages, if needed
\usepackage{float}  
...
\tikzstyle{decision} = [diamond, minimum width=4cm, minimum height=1cm, text centered, draw=black, fill=red!10]
...
\lstset{
  ...
  frame=single,
  columns=fullflexible, % ensures alignment
  captionpos=b
}
